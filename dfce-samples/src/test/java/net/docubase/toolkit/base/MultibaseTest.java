...
public class MultibaseTest extends AbstractBaseTestCase {
   ...
   public static void setUp() throws Exception {
      Authentication.openSession(ADM_LOGIN, ADM_PASSWORD, HOSTNAME, PORT, DOMAIN_ID);
   ...
   public void testSimple() throws Exception {
       ...
       */
      String query1 = base1.getBaseCategory(CATA).getFormattedName() + ":" + catValues.get(CATA);
      searchMono(base1, query1, 10, 1);

      String query2 = base2.getBaseCategory(CATA).getFormattedName() + ":" + catValues.get(CATA);
      ...
      /*
       * docs est ici alors une solution 'multibase'. On va chercher à extraire
       * les documents
       */
      Set<String> baseNames = new HashSet<String>();
      for (int i = 0; i < docs.size(); i++) {
         Document doc = docs.get(i);
         System.out.println("doc " + doc.getDocTitle() + " est dans la base: " + doc.getBaseId());
