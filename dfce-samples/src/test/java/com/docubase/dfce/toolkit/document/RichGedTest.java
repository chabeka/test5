...
public class RichGedTest extends AbstractBaseTestCase {
	...
	/*
	 * On injecte le nom du champs filtr� par formatFieldName dans la
	 * requ�te
	 */
	 ...
	 * � par exemple "1975-01-01 08-32". Le nom de la cat�gorie doit tjs
	 * �tre prot�g�. Mais on doit aussi mettre des "" autour du terme
	 * recherch�. Pour obtenir des requ�tes du type
	...
	/*
	 * On va stocker 100 documents, avec C0 qui change � chaque fois et C1
	...
	for (int i = 0; i < 10; i++) {
	    ...
	    /*
	     * L'objet r�sult contient une liste de Solution remont�e (ici ce
	     * sera 10 maximum) et le nombre th�orique de documents v�rifiant la
	     * requ�te (ici ce sera tjs 100)
	     */
	...
	/*
	 * On va stocker n documents, avec C0 qui change � chaque fois, et C1
	 * qui prend peu de valeurs. On joue aussi avec C2 multivalu�;)
	 */
	 ...
	 * personnes.
	 * 
	 * On a plusieurs fa�ons de chercher. On va consid�rer ici qu'il n'y a
	 * que les documents pr�c�demment inject�s (on n'applique plus
	 * TestFilter* sur C0) On va chercher � la fois sur C1 et C2.
	 * 
	...
	System.out
		.println("requ�te \"les adultes ou les individus de sexe masculin\" :\n"
			+ query);
     ...
     * et typ�es. Les recherches sont r�alis�es ici � la fois dans l'index GRC
     * et l'index LUCENE
     * 
     * @throws IOException
     * @throws ExceededSearchLimitException
	 ...
	 * 
	 * Les types sont nativement stock�s dans ces formats. Par contre, ce
	 * sont des repr�sentations chaines qui sont v�hicul�es jusqu'au
	 * serveur.
	 */
	...
	/*
	 * Ici on a donc une requ�te du genre "Cat 0:Identifier". Cette requete
	 * ne peut pas fonctionner (lucene n'aime pas les espaces dans les noms
	 * de champs => Erreurs de syntaxe au moment de parser la requ�te) En
	 * fait on stocke les noms de champs en casse basse et en rempla�ant les
	 * espaces par des char(255). Cel� est fait par la m�thode suivante,
	 * pour devenir "cat�0:Identifier" (vous pouvez v�rifier ce n'est pas un
	 * espace entre cat et 0 dans le commentaire pr�c�dent)
	 */
	...
	/*
	 * 
	 * Ce qui est fondamental : on doit pr�ciser une limite dans le nombre
	 * de r�sultats � remonter. Le serveur interdira les valeurs au del� de
