...
public class ZookeeperMutex {
   ...
   */
  public final boolean acquire(final long timeOut, final TimeUnit timeOutUnit) {
    try {
      return mutex.acquire(timeOut, timeOutUnit);
    } catch (final Exception e) {
      throw new RuntimeException("Erreur lors de la tentative de lock sur le chemin " + mutexPath, e);
    }
  }
   ...
   */
  public final synchronized boolean isObjectStillLocked(final long timeOut, final TimeUnit timeOutUnit) {
  ...
  public final void release() {
    try {
      ...
      throw new RuntimeException("Erreur lors de la libération du lock pour le chemin "
          + mutexPath, e);
    } finally {
