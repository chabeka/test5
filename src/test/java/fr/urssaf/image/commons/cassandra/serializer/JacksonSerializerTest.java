...
public class JacksonSerializerTest {
   ...
   @Test
   public void testJsonSerializer() throws UnsupportedEncodingException {
      JacksonSerializer<Object> os = new JacksonSerializer<Object>(Object.class);
      ...
      // Le test suivant ne fonctionne pas : car jackson voit un long au lieu d'une date
