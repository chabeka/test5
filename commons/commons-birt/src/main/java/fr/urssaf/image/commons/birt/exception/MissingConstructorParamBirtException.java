...
/**
 * 
 * Si un problème survient lors de l'instanciation du {@link fr.urssaf.image.commons.birt.BirtEngine}
 *
 */
public class MissingConstructorParamBirtException extends Exception {

   
   private static final long serialVersionUID = 7668402963696959540L;
    ...
    *         unknown.)
    */
	public MissingConstructorParamBirtException(String message,Throwable cause) {
		super(message, cause);
	}
