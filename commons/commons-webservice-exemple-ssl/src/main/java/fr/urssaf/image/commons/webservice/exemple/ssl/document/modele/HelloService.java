...
@WebServiceClient(name = "HelloService", 
                  wsdlLocation = "file:/G:/bbarault/eclipse_workspace/commons-webservice-exemple-ssl/src/test/resources/document_literal.wsdl",
...
public class HelloService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/G:/bbarault/eclipse_workspace/commons-webservice-exemple-ssl/src/test/resources/document_literal.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/G:/bbarault/eclipse_workspace/commons-webservice-exemple-ssl/src/test/resources/document_literal.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
