...
/**
 * 
 * Exception à lever lorsque la ressource n'est pas spécifiée (paramètre 
 * <code>name</code> manquant ou vide dans la <code>HttpServletRequest</code>)
 *
 */
public class RessourceNonSpecifieeException extends IOException {

   
   private static final long serialVersionUID = -4630127939692249143L;
