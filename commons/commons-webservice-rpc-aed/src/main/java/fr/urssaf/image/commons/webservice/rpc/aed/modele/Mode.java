...
public class Mode implements java.io.Serializable {
    ...
    public static final Mode reel = new Mode(_reel);
    public static final Mode test = new Mode(_test);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://AE.cirtil.cer69.recouv/AE.xsd1", "Mode"));
    }
    /**
