...
public class ObjectFactory {
    ...
    private final static QName _GetDocumentResponse_QNAME = new QName("http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", "getDocumentResponse");
    private final static QName _Save_QNAME = new QName("http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", "save");
    private final static QName _SaveResponse_QNAME = new QName("http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", "saveResponse");
    private final static QName _GetDocument_QNAME = new QName("http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", "getDocument");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", name = "getDocumentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", name = "save")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", name = "saveResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://document.service.exemple.spring.webservice.commons.image.urssaf.fr/", name = "getDocument")
