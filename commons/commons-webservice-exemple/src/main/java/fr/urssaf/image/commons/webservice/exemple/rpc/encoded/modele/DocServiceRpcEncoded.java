...
@WebServiceClient(name = "DocServiceRpcEncoded", 
                  wsdlLocation = "http://localhost:8080/commons-webservice-spring-exemple/service/DocServiceRpcEncoded?WSDL",
...
public class DocServiceRpcEncoded extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/commons-webservice-spring-exemple/service/DocServiceRpcEncoded?WSDL");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/commons-webservice-spring-exemple/service/DocServiceRpcEncoded?WSDL");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
