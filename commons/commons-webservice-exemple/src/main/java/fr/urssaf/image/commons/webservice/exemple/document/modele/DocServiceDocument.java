...
@WebServiceClient(name = "DocServiceDocument", 
                  wsdlLocation = "https://localhost:8443/commons-webservice-spring-exemple/service/DocServiceDocument?wsdl",
...
public class DocServiceDocument extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("https://localhost:8443/commons-webservice-spring-exemple/service/DocServiceDocument?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from https://localhost:8443/commons-webservice-spring-exemple/service/DocServiceDocument?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
