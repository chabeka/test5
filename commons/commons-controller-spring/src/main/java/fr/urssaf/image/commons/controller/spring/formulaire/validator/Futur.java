...
import fr.urssaf.image.commons.controller.spring.formulaire.validator.support.FuturValidator;

@ValidatorAnnotation(FuturValidator.class)
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
@Documented
public @interface Futur {
