...
/**
 * Si la source HTML à parser est manquante
 *
 */
public class MissingSourceParserException extends Exception {

   
   private static final long serialVersionUID = 1260210815285063445L;
    ...
    */
   public MissingSourceParserException(String message) {  
      super(message); 
   }
