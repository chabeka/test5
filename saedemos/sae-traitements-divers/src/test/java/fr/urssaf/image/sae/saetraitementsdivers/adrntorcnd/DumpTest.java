...
public class DumpTest {
   ...
   private class CodeRndComparator implements Comparator<String> {
      ...
      private int compareDigit(String digit1, String digit2) {
         ...
         } else if (StringUtils.isNumeric(digit1) && !StringUtils.isNumeric(digit2)) {
            result = -1;
         } else if (!StringUtils.isNumeric(digit1) && StringUtils.isNumeric(digit2)) {
            result = 1;
         } else {
   ...
   public void dumpDureeArchivage() throws ServiceException, RemoteException {
      ...
      for(ComptageInt comptage: comptagesTries) {
         System.out.println(
               String.format(
                     "Durée %1$4s : %2$4s type(s) de documents",
                     comptage.valeur,
                     comptage.comptage));
      }
   ...
   public void dumpUnCodeRND() throws ServiceException, RemoteException {
      ...
      for(RNDTypeDocument typeDoc : typesDoc) {
         ...
         if (codeRnd.equals(codeRndRecherche)) {
            ...
            System.out.println(String.format("commentaire : %s",typeDoc.get_commentaire()));
            System.out.println(String.format("dlc : %s",typeDoc.get_dlc()));
            System.out.println(String.format("dureeArchivage : %s",typeDoc.get_dureeArchivage()));
            System.out.println(String.format("idVersion : %s",typeDoc.get_idVersion()));
            System.out.println(String.format("label : %s",typeDoc.get_label()));
            System.out.println(String.format("refActivite : %s",typeDoc.get_refActivite()));
            System.out.println(String.format("reference : %s",typeDoc.get_reference()));
            System.out.println(String.format("refFonction : %s",typeDoc.get_refFonction()));
            System.out.println(String.format("refProcessus : %s",typeDoc.get_refProcessus()));
            System.out.println(String.format("refSecteurActivite : %s",typeDoc.get_refSecteurActivite()));
            System.out.println(String.format("responsabilite : %s",typeDoc.get_responsabilite()));
            System.out.println(String.format("type : %s",typeDoc.get_type()));
            System.out.println(String.format("typePJ : %s",typeDoc.get_typePJ()));
            System.out.println(String.format("is_archivable : %s",typeDoc.is_archivable()));
            System.out.println(String.format("is_archiveHisto : %s",typeDoc.is_archiveHisto()));
            System.out.println(String.format("is_destructionAutorisee : %s",typeDoc.is_destructionAutorisee()));
            System.out.println(String.format("is_etat : %s",typeDoc.is_etat()));
            System.out.println(String.format("is_pj : %s",typeDoc.is_pj()));
            System.out.println(String.format("is_reserveCNM : %s",typeDoc.is_reserveCNM()));
   ...
   @Test
   public void dumpTypesDocSansCodeFonction() throws ServiceException, RemoteException {
      ...
      System.out.print(String.format("%s type(s) de document sans code fonction", codesRnd.size()));
      System.out.println(String.format(" sur %s types de document",typesDoc.length));
   ...
   @Test
   public void dumpTypesDocSansCodeActivite() throws ServiceException, RemoteException {
      ...
      // Dump
      Collections.sort(codesRnd, new CodeRndComparator());
      System.out.print(String.format("%s type(s) de document sans code activité", codesRnd.size()));
      System.out.println(String.format(" sur %s types de document",typesDoc.length));
      System.out.println(StringUtils.EMPTY);
      for (String codeRnd: codesRnd) {
         System.out.println(codeRnd);
   ...
   @Test
   public void dumpTypesDocSansLibelle() throws ServiceException, RemoteException {
      ...
      // Dump
      Collections.sort(codesRnd, new CodeRndComparator());
      System.out.print(String.format("%s type(s) de document sans libellé", codesRnd.size()));
      System.out.println(String.format(" sur %s types de document",typesDoc.length));
      System.out.println(StringUtils.EMPTY);
      for (String codeRnd: codesRnd) {
         System.out.println(codeRnd);
