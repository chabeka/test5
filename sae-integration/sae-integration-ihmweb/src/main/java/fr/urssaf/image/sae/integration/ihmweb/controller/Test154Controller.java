 ...
 * Test 154<br>
 * <br>
 * On vérifie que la bonne erreur est renvoyée lorsqu'une 
 * métadonnée obligatoire a une valeur vide.
 */
@Controller
...
public class Test154Controller extends AbstractTestWsController<TestWsCaptureUnitaireFormulaire> {
   ...
   protected final TestWsCaptureUnitaireFormulaire getFormulairePourGet() {
      ...
      // URL ECDE
      formCapture.setUrlEcde("ecde://ecde.cer69.recouv/SAE_INTEGRATION/20110822/CaptureUnitaire-154-CaptureUnitaire-KO-MetadonneeObligatoireVide/documents/doc1.PDF");
