...
public class CaptureUnitaireTestService {
   ...
   private CaptureUnitaireResultat appelWsOpCaptureUnitaire(
      ...
      try 
      {
         ...
         ArchivageUnitaire paramsService = SaeServiceObjectFactory.buildArchivageUnitaireRequest(
         ...
         String idArchivage = SaeServiceTypeUtils.extractUuid(
               response.getArchivageUnitaireResponse().getIdArchive());
         
         // Log de la réponse obtenue
         log.appendLogNewLine();
         log.appendLogLn("Détails de la réponse obtenue de l'opération \"archivageUnitaire\" :");
         SaeServiceLogUtils.logResultatCaptureUnitaire(
               resultatTest, 
         ...
         // Calcul du SHA-1 du fichier envoyé, et affectation à l'objet de réponse
         String sha1 = ecdeService.sha1(formulaire.getUrlEcde());
         result.setSha1(sha1);
         log.appendLogNewLine();
         log.appendLogLn("Pour information, le SHA-1 du fichier envoyé à la capture est : ");
   ...
   /**
    * Test libre de l'appel à l'opération "archivageUnitaire" du service web SaeService.<br>
    * 
    ...
    */
   public final void appelWsOpCaptureUnitaireSoapFault(
         String urlServiceWeb,
         CaptureUnitaireFormulaire formulaire,
         String ficVi,
   ...
   public final CaptureUnitaireResultat appelWsOpCaptureUnitaireReponseAttendue(
      ...
      ResultatTest resultatTest = formulaire.getResultats();
      if ((resultat!=null) && (TestStatusEnum.NonLance.equals(resultatTest.getStatus()))) {
