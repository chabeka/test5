 ...
 * Test 101<br>
 * <br>
 * On vérifie que la capture unitaire fonctionne dans des 
 * conditions "standards" d'utilisation.
 */
@Controller
@RequestMapping(value = "test101")
public class Test101Controller extends AbstractTestWsController<Test101Formulaire> {
   ...
   protected final Test101Formulaire getFormulairePourGet() {
      ...
      formCapture.setUrlEcde(
            "ecde://ecde.cer69.recouv/SAE_INTEGRATION/20110822/CaptureUnitaire-101-CaptureUnitaire-OK-Standard/documents/doc1.PDF");
      ...
      CodeMetadonneeList codesMeta = getRefMetas().listeMetadonneesConsultables();
   ...
   private void etape2recherche(
         Test101Formulaire formulaireTest101) {
   ...
   private void verifieResultatRecherche(
      ...
      valeursAttendues.add("Denomination","Test 101-CaptureUnitaire-OK-Standard");
   ...
   private void etape3consultation(
         Test101Formulaire formulaire) {
