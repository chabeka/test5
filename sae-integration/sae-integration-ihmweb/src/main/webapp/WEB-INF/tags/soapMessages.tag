...
<table border="0" cellspacing="3" cellpadding="3" style="width: 100%;">
	<tr style="vertical-align: top;">
		<td style="width: 50%;" align="right">Message Envoyé : <br /><textarea rows="8"
			cols="50" readonly="readonly">
         	<c:out value="${objetFormulaire.messageOut}" />
         </textarea></td>
		<td
			style="width: 50%; border-left-width: 2px; border-left-color: black; border-left-style: solid;">
		Message reçu :<br /><textarea rows="8" cols="50" readonly="readonly">
         <c:out value="${objetFormulaire.messageIn}" />
         </textarea></td>
	</tr>
</table>
