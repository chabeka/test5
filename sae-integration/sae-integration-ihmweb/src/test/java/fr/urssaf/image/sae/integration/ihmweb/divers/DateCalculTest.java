...
public class DateCalculTest {
   ...
   private static final Logger LOG = Logger.getLogger(DateCalculTest.class);
   ...
   public void calculeDateFinConservation() {
      ...
      calendar.set(Calendar.MONTH,moisDebutConservation-1); // les numéros de mois commencent à 0
      ...
      Date dateFinConservation = DateUtils.addDays(
