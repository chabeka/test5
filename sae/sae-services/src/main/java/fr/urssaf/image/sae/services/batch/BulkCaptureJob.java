...
public class BulkCaptureJob extends  CommonIndicator{
   ...
   .getLogger(BulkCaptureJob.class);
	...
	public JmxIndicator retrieveJmxBulkCaptureJobIndicator() {
		storageServiceProvider.getStorageDocumentService().setJmxIndicator(getIndicator());
		return storageServiceProvider.getStorageDocumentService().retrieveJmxStorageIndicator()	;
